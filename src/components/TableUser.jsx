...
const TableUser = () => {
  ...
  <h4 className="font-semibold text-xl text-black dark:text-white mb-6">Daftar User</h4>

  <div className="flex flex-col">
    <div className="grid grid-cols-3 sm:grid-cols-5 bg-gray-2 dark:bg-meta-4 rounded-sm">
      <div className="p-2.5 xl:p-5">
        <h5 className="font-medium text-sm xsm:text-base uppercase">Nama</h5>
      </div>
      <div className="p-2.5 xl:p-5 text-center">
        <h5 className="font-medium text-sm xsm:text-base uppercase">NIS</h5>
      </div>
      <div className="p-2.5 xl:p-5 text-center">
        <h5 className="font-medium text-sm xsm:text-base uppercase">Kelas</h5>
      </div>
      <div className="hidden sm:block p-2.5 xl:p-5 text-center">
        <h5 className="font-medium text-sm xsm:text-base uppercase">Email</h5>
      </div>
      <div className="hidden sm:block p-2.5 xl:p-5 text-center">
        <h5 className="font-medium text-sm xsm:text-base uppercase">Akurasi</h5>
      </div>
    </div>
